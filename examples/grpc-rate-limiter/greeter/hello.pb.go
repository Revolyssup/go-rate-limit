...
const file_hello_proto_rawDesc = "" +
	...
	"\aGreeter\x126\n" +
	"\bSayHello\x12\x15.greeter.HelloRequest\x1a\x13.greeter.HelloReplyB>Z<github.com/Revolyssup/examples/grpc-rate-limiter/pkg;greeterb\x06proto3"
